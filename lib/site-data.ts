...
export const productPillars = [
  {
    title: "一页看清时间、票务和动线",
    body: "把活动时间、开票入口、场馆交通和选座提醒放在同一条浏览路径里，少来回切页面。"
  },
  {
    title: "艺人页不只是名字列表",
    body: "成员档案、官方入口、已官宣场次和下一轮巡演消息，会一起收在同一个主页里。"
  },
  {
    title: "像粉丝会收藏的情报站",
    body: "不做后台感页面，而是把站点做成打开之后愿意继续点进艺人、场馆和城市指南的入口。"
  }
];
...
export const launchHighlights = [
  {
    title: "艺人范围持续铺开",
    body: "主流男团、女团、solo 和新团都已经开始收录，方便你按本命一路往下看。"
  },
  {
    title: "正式排期 + 巡演消息",
    body: "日期已经落地的场次会进正式日历，仍在发酵的巡演动向会单独提醒，不把风声写成官宣。"
  },
  {
    title: "成员档案直接可看",
    body: "艺人页不只给一句简介，而是把成员 profile、现场看点和相关指南一起整理出来。"
  }
];
